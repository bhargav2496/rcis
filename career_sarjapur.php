...
<body>
    ...
    <!-- -------------about banner-------------- -->
    <div class="image-career-sarjapur-banner" style="margin-top:70px;height: 450px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="lg-text">Careers</h1>
                    <p class="image-career-sarjapur-para">At Sarjapur</p>
                </div>
            </div>
        </div>
    </div>
...
Currently, we have the following openings
    ...
    <section id="tabs" class="project-tab">
        ...
        <div class="about-rcis">
        <h4 class="text-center" style="color: maroon;">Send in your resume to <a href="mailto:rcissarjapur@gmail.com" style="color: black;">rcissarjapur@gmail.com</a></h4>
        </div>
