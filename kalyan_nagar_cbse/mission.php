...
<body>
    ...
    <!-- -------------home banner-------------- -->
    <div class="image-mission-banner" style="margin-top:70px;height: 450px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="lg-text">Our Mission</h1>
                    <p class="image-mission-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- ----------welcome message------------ -->
    <div class="welcome">
        <h1 class="text-center" id="media" style="color: #1ca250;margin-top: 15px;">Vision</h1>
        <!-- <h5 class="text-center">Fourteen years and still counting!</h5> -->
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12" data-aos="fade-right">
                    <p>To create knowledgeable global citizens firmly rooted in Indian culture, dynamic leaders and lifelong learners. RCIS fosters values of love, empathy, discipline and respect to have a holistic development.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- ----------welcome message------------ -->
    <div class="welcome">
        <h1 class="text-center" id="media" style="color: #1ca250;margin-top: 15px;">Our Mission</h1>
        <!-- <h5 class="text-center">Fourteen years and still counting!</h5> -->
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12" data-aos="fade-right">
