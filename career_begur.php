...
<body>
    ...
    <!-- -------------about banner-------------- -->
    <div class="image-career-Begur-banner" style="margin-top:70px;height: 450px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="lg-text">Careers</h1>
                    <p class="image-career-Begur-para">At Begur</p>
                </div>
            </div>
        </div>
    </div>
...
Currently, we have the following openings
    ...
    <section id="tabs" class="project-tab">
                                ...
                                <table class="table" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sarjapur-career">Section</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td>Hindi Teacher</td>
                                            <td>Middle and Senior School</td>
                                        </tr>
                                        <tr>
                                            <td>6</td>
        ...
        <div class="about-rcis">
        <h4 class="text-center" style="color: maroon;">Send in your resume to <a href="mailto:info.begur@rcis.in" style="color: black;">info.begur@rcis.in</a></h4>
        </div>
