...
<body>
    ...
    <div class="about-rcis">
        <h1 class="text-center" style="color: maroon;">Our Locations</h1>
    ...
    <!-- ----------------branches------------- -->
    <div class="box">
        <h1 class="text-center" style="color: maroon;">Our Branches</h1>
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="box-part text-center">
                        <img src="images\school_branches\rcis_kalyannagar_cbse.jpg" alt="">
                        <div class="title">
                            <h4>RCIS, Kalyan Nagar,CBSE</h4>
                        </div>
                        <div class="text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="box-part text-center">
                        <img src="images\school_branches\rcis_kalyannagar_icse.jpg" alt="">
                        <div class="title">
                            <h4>RCIS, Kalyan Nagar, ICSE</h4>
                        </div>
                        <div class="text">
                            <p> # 21, Premises Annex building, Kalyan nagar, Cheliekere Village, Arkavathi Layout, Bengaluru East -560043
                            </p>
                            <p>
                                <a href="tel:8050056262" style="color: black;">+91 8050056262</a>/
                                <a href="tel:8050056363" style="color: black;">8050056363</a>/
                                <a href="tel:+919071399777" style="color: black;">+91 9071 399 777</a>
                            </p>
                            <p>
                                <a href="mailto: rcisannex@gmail.com" style="color: black;">rcisannex@gmail.com</a>
                            </p>
                        </div>
                        <a href="#">Learn More</a>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="box-part text-center">
                        <img src="images\school_branches\rcis_mysuru.jpg" alt="">
                        <div class="title">
                            <h4>RCIS, Mysuru</h4>
                        </div>
                        <div class="text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="box-part text-center">
                        <img src="images\school_branches\rcis_sarjapur.jpg" alt="">
                        <div class="title">
                            <h4>RCIS, sarjapur</h4>
                        </div>
                        <div class="text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="box-part text-center">
                        <img src="images\school_branches\rcis_begur.jpg" alt="">
                        <div class="title">
                            <h4>RCIS, Begur</h4>
                        </div>
                        <div class="text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="box-part text-center">
                        <img src="images\school_branches\rcis_mspalya.jpg" alt="">
                        <div class="title">
                            <h4>RCIS, MS Palya</h4>
                        </div>
                        <div class="text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="box-part text-center">
                        <img src="images\school_branches\rcis_chamarajpet.jpg" alt="">
                        <div class="title">
                            <h4>RCIS, Chamarajpet</h4>
                        </div>
                        <div class="text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="box-part text-center">
                        <img src="images\school_branches\rcis_kalyannagar_puc.jpg" alt="">
                        <div class="title">
                            <h4>RCIS, Kalyan Nagar, PUC</h4>
                        </div>
                        <div class="text">
                            <p>#21, Chelekere Village, Arkavathi layout, KR Puram Hobli, Bengaluru – 560043.</p>
                            <p>
                                <a href="tel:8050056767" style="color: black;">8050056767</a>
                                <a href="tel:9449367878" style="color: black;">9449367878</a>
                                <a href="tel:+919071399777" style="color: black;">+91 9071399777</a>
                            </p>
                            <p>
                                <a href="mailto: principal@rcis.in" style="color: black;">principal@rcis.in</a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="box-part text-center">
                        <img src="images\school_branches\rcis_begur_puc.jpg" alt="">
                        <div class="title">
                            <h4>RCIS, Begur, PUC</h4>
                        </div>
                        <div class="text">
                            <p>#81/1, Hongasandra, Begur Main Road, Bangalore – 560068</p>
                            <p>
                                <a href="tel:08025742060" style="color: black;">080-25742060</a>
                                <a href="tel:8884459797" style="color: black;">8884459797</a>
                                <a href="tel:+919071399777" style="color: black;">+91 9071399777</a>
                            </p>
                            <p>
                                <a href="mailto: principal.begur@rcis.in" style="color: black;">principal.begur@rcis.in</a>
