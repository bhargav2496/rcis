...
<body>
    ...
    <!-- -------------about banner-------------- -->
    <div class="image-career-ms-palya-banner" style="margin-top:70px;height: 450px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="lg-text">Careers</h1>
                    <p class="image-career-ms-palya-para">At MS Palya</p>
                </div>
            </div>
        </div>
    </div>
...
Currently, we have the following openings
    ...
    <section id="tabs" class="project-tab">
        ...
        <div class="about-rcis">
        <h4 class="text-center" style="color: maroon;">Send in your resume to <a href="mailto:info.yelahanka@rcis.in" style="color: black;">info.yelahanka@rcis.in</a></h4>
        </div>
