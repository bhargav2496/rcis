...
<body>
    ...
    <!-- -------------about banner-------------- -->
    <div class="image-aboutus-banner" style="margin-top:70px;height: 450px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <!-- ------------------welcome------------ -->
    <div class="about-rcis">
        <h1 class="text-center" style="color: maroon;">About RCIS</h1>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">

                    <p style="text-align: justify;">Royale Concorde International School is devoted to excellence in developing a child’s overall personality and self esteem by not only focusing on academic excellence but also nurturing their natural curiosity, encouraging creative
                        freedom and self expression. A belief in self and the inculcated positive social values makes the child ready to take his/her place in the world proudly. With 6 branches spread across Bangalore and Mysore, RCIS is committed to
                        progressive, inclusive and holistic education reaching your child. Our education facilities are equipped with world class infrastructure & excellent teaching staff. As part of holistic learning experience, your child is encouraged
                        to demonstrate his/her talent, skills and interest in activities outside classroom too.
                    </p>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <img class="about-logo" src="images\aboutus\royale-concorde-international-school.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="about-rcis">
        <h1 class="text-center" style="color: maroon;">Our Mission</h1>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <img   src="images\aboutus\rcis-mission.jpg" alt="" style="width: 100%; height: 264px;">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <ul>
                        <li style="text-align: justify;">Our endeavour is to impart education that goes beyond the formal schooling and empowers individuals to be achievers in their chosen fields through experience.</li>
                        <li style="text-align: justify;">We envisage a system which aims at a multifaceted development of the child’s physical, emotional, mental and spiritual personality by nurturing their innate potential, encouraging creative freedom and self expression.</li>
                        <li style="text-align: justify;">Our mission is to inspire, educate, challenge and support all students to reach their highest level of learning and personal development.</li>
                    </ul>
                </div>
    ...
    <!-- ----------------vision---------------------------- -->
    <div class="vision-rcis">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 vision-section">
                    <h1 class="text-center"><span style="color: maroon;">Our Vision</span> | <span style="color: maroon;">Our Methods </span>| <span style="color: maroon;">Our Difference</span></h1>
                    <center><img src="images\aboutus\vision.png" alt="" class="vision-image"></center>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <p style="text-align: center;">As the child enters the teen years (Grades V to X), the pace of academics is gradually accelerated. The student’s intellectual, aesthetic, physical and cultural growth is strengthened. They are introduced to a foundation course designed
                        to suit students from the Indian, as well as an International background. Academic challenges become the focus as the students start preparing for the Council For The Indian School Certificate Examinations (CISCE), CBSE (Central
                        Board of Secondary Education) and the International General Certificate of Secondary Education (IGCSE) examinations.</p>
                    <p style="text-align: center;">Throughout these crucial, formative academic years, our consistent effort is to prepare students for the real world. Hence, a host of projects and field trips further augment classroom instruction, where great emphasis is laid on the
                        development of positive attitudes and healthy habits. Students are encouraged to question, hypothesize, analyze and be creative.</p>
                </div>
            </div>
        </div>
    </div>
