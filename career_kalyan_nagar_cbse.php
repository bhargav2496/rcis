...
<body>
    ...
    <!-- -------------about banner-------------- -->
    <div class="image-career-kalyan_cbse-banner" style="margin-top:70px;height: 450px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="lg-text">Careers</h1>
                    <p class="image-career-kalyan_cbse-para">At Kalyan Nagar</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-6">
                    <p>A truly special teacher is very wise, and sees tomorrow in every child's eyes.</p>
                    <p>We are always looking for teachers who can not only explain, but inspire the students along with their co-workers.
Currently, we have the following openings
    ...
    <section id="tabs" class="project-tab">
                ...
                <div class="row">
                    <div class="col-md-12">
                                <table class="table" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th class="sarjapur-career">Sl No.</th>
                                            <th class="sarjapur-career">Post</th>
                                            <th class="sarjapur-career">Subject</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>PGT</td>
                                            <td>Maths, Chemistry</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>TGT</td>
                                            <td>Maths, Social Science, English</td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td>PRT</td>
                                        ...
                                        <tr>
                                            <td>4</td>
                                            <td>Music and Dance teachers</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td>5</td>
                                        ...
                                        <tr>
                                            <td>6</td>
                                            <td>Admin Assistants</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td>7</td>
                                            <td>Accounts assistants</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td>8</td>
        ...
        <div class="about-rcis">
        <h4 class="text-center" style="color: maroon;">Send in your resume to <a href="mailto:info.kalyannagar@rcis.in" style="color: black;">info.kalyannagar@rcis.in</a></h4>
        </div>
