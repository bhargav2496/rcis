...
<body>
    ...
    <!-- -------------about banner-------------- -->
    <div class="image-mysore-career-banner" style="margin-top:70px;height: 450px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="lg-text">Careers</h1>
                    <p class="image-mysore-career-para">At Mysuru</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="about-rcis">
        <h1 class="text-center" style="color: maroon;">Careers</h1>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-6">
                    <p><b>KINDERGARTEN TEACHERS</b></p>
                    <p>BA/B.Sc. / B.Com with NTT. 2 to 3 years’ experience.</p>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-6">
                    <p><b>GRADUATE TEACHER</b></p>
                    <p>BA/B.Sc. / B.Com with B.Ed.2 to 3 years’ experience. Subjects:-English, Hindi, Mathematics, Science.</p>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-6">
                    <p><b>POSTGRADUATE TEACHERS</b></p>
                    <p>MA/M.Sc./M.Com/B.E with B.Ed.4 to 5 years’ experience. Specialisation in subjects English, Hindi, Mathematics, Physics, Chemistry, Biology, Computer science Art & craft teacher B.A fine arts with 2 to 3 years.</p>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-6">
                    <p><b>ADMINISTRATION:</b></p>
                    <p>M.Com with MBA Accountancy, with tally experience.3 to 4 years’ experience.</p>
                    <p>For all posts candidates should be dynamic, experienced and should have excellent English Communication skills.</p>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-6">
                    <p><b>Share your resume @: </b></p>
